...
func (builder *Builder) Create() (*Builder, error) {
	...
	err := builder.ResourceCRUD.Create(builder.Definition.Namespace, builder.Definition.Name, builder.Definition)
	if err != nil {
		return builder, err
	}
...
func (builder *Builder) Update() (*Builder, error) {
	...
	if err := builder.ResourceCRUD.Update(builder.Definition.Namespace, builder.Definition.Name, builder.Definition); err != nil {
		return builder, err
	}
...
func (builder *Builder) Exists() bool {
	return builder.ResourceCRUD.Exists(builder.Definition.Namespace, builder.Definition.Name)
}
