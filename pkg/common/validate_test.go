...
func TestValidateBuilder(t *testing.T) {
	...
	for _, tc := range testCases {
		testBuilder := &mockBuilder{
			definitionFunc:   func() interface{} { return tc.definitionReturnValue },
			errorMsgFunc:     func() string { return tc.errorMsgReturnValue },
			apiClientFunc:    func() interface{} { return tc.apiClientReturnValue },
			resourceTypeFunc: func() string { return tc.resourceTypeReturnValue },
		}
	...
	// One additonal test case for nil builder
